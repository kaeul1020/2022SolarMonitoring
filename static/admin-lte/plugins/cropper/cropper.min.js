...
!(function (t, i) {
  ...
  function wt(t, i, e) {
    var a = void 0;
    return (
      tt(Event) && tt(CustomEvent) ? (a = new CustomEvent(i, { detail: e, bubbles: !0, cancelable: !0 })) : (a = document.createEvent("CustomEvent")).initCustomEvent(i, !0, !0, e), t.dispatchEvent(a)
    );
  }
  function yt(t) {
    var i = t.getBoundingClientRect();
    return { left: i.left + (window.pageXOffset - document.documentElement.clientLeft), top: i.top + (window.pageYOffset - document.documentElement.clientTop) };
  }
  var Mt = r.location,
    Ct = /^(https?:)\/\/([^:/?#]+):?(\d*)/i;
  function Dt(t) {
  ...
  var Ot = {
      ...
      initContainer: function () {
        var t = this.element,
          ...
          a = this.cropper;
        ht(a, S), rt(t, S);
        var n = { width: Math.max(e.offsetWidth, Number(i.minContainerWidth) || 200), height: Math.max(e.offsetHeight, Number(i.minContainerHeight) || 100) };
      ...
      limitCanvas: function (t, i) {
        ...
        if (t) {
          ...
          1 < h
            ? ((c = Math.max(c, a.width)), (d = Math.max(d, a.height)), 3 === h && (c < d * r ? (c = d * r) : (d = c / r)))
            : 0 < h && (c ? (c = Math.max(c, s ? o.width : 0)) : d ? (d = Math.max(d, s ? o.height : 0)) : s && ((c = o.width) < (d = o.height) * r ? (c = d * r) : (d = c / r)));
          ...
          if (h) {
            ...
            (n.minLeft = Math.min(0, p)),
              ...
              s &&
                ...
                (n.maxLeft = o.left),
                (n.maxTop = o.top),
                2 === h && (n.width >= a.width && ((n.minLeft = Math.min(0, p)), (n.maxLeft = Math.max(0, p))), n.height >= a.height && ((n.minTop = Math.min(0, m)), (n.maxTop = Math.max(0, m)))));
      ...
      renderCanvas: function (t, i) {
        ...
        (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
          ...
          (e.oldLeft = e.left),
          (e.oldTop = e.top),
          ot(this.canvas, et({ width: e.width, height: e.height }, kt({ translateX: e.left, translateY: e.top }))),
          this.renderImage(t),
      ...
      renderImage: function (t) {
        ...
        et(e, { width: a, height: n, left: (i.width - a) / 2, top: (i.height - n) / 2 }),
          ot(this.image, et({ width: e.width, height: e.height }, kt(et({ translateX: e.left, translateY: e.top }, e)))),
          t && this.output();
      },
      ...
      limitCropBox: function (t, i) {
        ...
        if (t) {
          ...
          (s = Math.min(s, a.width)),
            ...
            r && (s && c ? (s < c * r ? (c = s / r) : (s = c * r)) : s ? (c = s / r) : c && (s = c * r), d < l * r ? (l = d / r) : (d = l * r)),
        ...
        i &&
          (h
            ...
            : ((o.minLeft = 0), (o.minTop = 0), (o.maxLeft = a.width - o.width), (o.maxTop = a.height - o.height)));
      },
      renderCropBox: function () {
        ...
        (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
          ...
          ot(this.cropBox, et({ width: e.width, height: e.height }, kt({ translateX: e.left, translateY: e.top }))),
        ...
        this.cropped &&
          ...
          it(this.previews, function (t) {
            ...
            s && (o = c * (h = e / s)),
              ...
              ot(t.getElementsByTagName("img")[0], et({ width: d * h, height: l * h }, kt(et({ translateX: -p * h, translateY: -m * h }, r))));
          }));
      },
    },
    Yt = {
        ...
        if (!this.disabled) {
          ...
          t.changedTouches
            ...
            i &&
              ...
              this.cropping && ((this.cropping = !1), st(this.dragBox, o, this.cropped && this.options.modal)),
    ...
    Rt = {
      change: function (t) {
        ...
        !r && t.shiftKey && (r = d && l ? d / l : 1),
          this.limited && ((u = n.minLeft), (g = n.minTop), (f = u + Math.min(a.width, e.width, e.left + e.width)), (v = g + Math.min(a.height, e.height, e.top + e.height)));
        var x,
          y,
          M,
          C = o[Object.keys(o)[0]],
        ...
        switch (h) {
          ...
          case Y:
            if (r) {
              ...
              B(O),
                B(N),
                D.x <= 0 ? (u < s ? ((d -= D.x), (s += D.x)) : D.y <= 0 && c <= g && (w = !1)) : ((d -= D.x), (s += D.x)),
          ...
          case T:
            ...
            (b = yt(this.cropper)),
              ...
              D.y < 0 && (c -= l),
              this.cropped || (rt(this.cropBox, S), (this.cropped = !0), this.limited && this.limitCropBox(!0, !0));
        }
    ...
    St = {
      crop: function () {
        return (
          !this.ready ||
            this.cropped ||
            this.disabled ||
            ((this.cropped = !0), this.limitCropBox(!0, !0), this.options.modal && ht(this.dragBox, o), rt(this.cropBox, S), this.setCropBoxData(this.initialCropBoxData)),
          this
        );
      },
      reset: function () {
        ...
        return (
          !this.disabled &&
            ...
            t
              ...
              : (this.isImg && (this.replaced = !0), (this.options.data = null), this.uncreate(), this.load(i))),
          this
        );
      },
      enable: function () {
      ...
      moveTo: function (t) {
        ...
        return (
          (t = Number(t)),
          (i = Number(i)),
          this.ready && !this.disabled && this.options.movable && (K(t) && ((e.left = t), (a = !0)), K(i) && ((e.top = i), (a = !0)), a && this.renderCanvas(!0)),
          this
        );
      },
      zoom: function (t, i) {
      ...
      scale: function (t) {
        ...
        return (
          (t = Number(t)),
          (i = Number(i)),
          this.ready && !this.disabled && this.options.scalable && (K(t) && ((e.scaleX = t), (a = !0)), K(i) && ((e.scaleY = i), (a = !0)), a && this.renderCanvas(!0, !0)),
          this
        );
      },
      getData: function () {
      ...
      setData: function (t) {
        ...
        if (this.ready && !this.disabled && _(t)) {
          ...
          i.rotatable && K(t.rotate) && t.rotate !== e.rotate && ((e.rotate = t.rotate), (o = !0)),
            i.scalable && (K(t.scaleX) && t.scaleX !== e.scaleX && ((e.scaleX = t.scaleX), (o = !0)), K(t.scaleY) && t.scaleY !== e.scaleY && ((e.scaleY = t.scaleY), (o = !0))),
      ...
      setCanvasData: function (t) {
        ...
        return (
          this.ready &&
            ...
            K(t.top) && (i.top = t.top),
            K(t.width) ? ((i.width = t.width), (i.height = t.width / e)) : K(t.height) && ((i.height = t.height), (i.width = t.height * e)),
            this.renderCanvas(!0)),
          this
        );
      },
      getCropBoxData: function () {
        var t = this.cropBoxData,
          i = void 0;
        return this.ready && this.cropped && (i = { left: t.left, top: t.top, width: t.width, height: t.height }), i || {};
      },
      ...
      getCroppedCanvas: function () {
        ...
        var V = F / Z,
          ...
          _ = Et({ aspectRatio: V, width: t.width || (1 !== K ? P.width : F), height: t.height || (1 !== K ? P.height : Z) }),
          tt = _.width,
          it = _.height;
        ...
        var rt = P.width,
          ...
          gt = void 0,
          ft = void 0;
        ct <= -F || rt < ct ? (gt = mt = lt = ct = 0) : ct <= 0 ? ((mt = -ct), (ct = 0), (gt = lt = Math.min(rt, F + ct))) : ct <= rt && ((mt = 0), (gt = lt = Math.min(F, rt - ct))),
          lt <= 0 || dt <= -Z || st < dt ? (ft = ut = pt = dt = 0) : dt <= 0 ? ((ut = -dt), (dt = 0), (ft = pt = Math.min(st, Z + dt))) : dt <= st && ((ut = 0), (ft = pt = Math.min(Z, st - dt)));
        var vt = [ct, dt, lt, pt];
        if (0 < gt && 0 < ft) {
          var wt = tt / F;
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.image = n),
                  (this.onStart = o),
                  (this.onStop = h),
                  this.isImg ? (t.complete ? (this.timeout = setTimeout(o, 0)) : vt(t, y, o, { once: !0 })) : ((n.onload = o), (n.onerror = h), ht(n, p), t.parentNode.insertBefore(n, t.nextSibling));
              },
            },
            {
              key: "start",
              value: function (t) {
                ...
                var a = r.navigator && /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(r.navigator.userAgent),
                  n = function (t, i) {
                    et(e.imageData, { naturalWidth: t, naturalHeight: i, aspectRatio: t / i }), (e.sizing = !1), (e.sized = !0), e.build();
                  };
                if (!i.naturalWidth || a) {
                  ...
                  ((this.sizingImage = o).onload = function () {
                    ...
                    (o.src = i.src),
                    a ||
                      ((o.style.cssText = "left:0;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;opacity:0;position:absolute;top:0;z-index:-1;"),
                      h.appendChild(o));
              ...
              value: function () {
                if (this.sized && !this.ready) {
                  ...
                  (this.container = a),
                    ...
                    i.cropBoxResizable || (ht(s.getElementsByClassName(l + "-line"), S), ht(s.getElementsByClassName(l + "-point"), S)),
                    this.render(),
                    (this.ready = !0),
