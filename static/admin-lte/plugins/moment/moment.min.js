          ...
          M(s)
            ...
            : (a(s)
                ...
                ? (function (e) {
                    var t = wt.exec(e._i);
                    null === t
                      ? (kt(e), !1 === e._isValid && (delete e._isValid, Dt(e), !1 === e._isValid && (delete e._isValid, e._strict ? (e._isValid = !1) : f.createFromInputFallback(e))))
                      : (e._d = new Date(+t[1]));
                  })(t)
                : o(n)
  ...
  function qt(s, i) {
    return function (e, t) {
      ...
      return (
        null === t ||
          isNaN(+t) ||
          (Y(i, "moment()." + i + "(period, number) is deprecated. Please use moment()." + i + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
          (n = e),
          (e = t),
          (t = n)),
        Bt(this, Zt(e, t), s),
  ...
  (pn.add = Jt),
    ...
    (pn.utcOffset = function (e, t, n) {
      ...
      return (
        ...
        null != s && this.add(s, "m"),
        i !== e &&
          (!t || this._changeInProgress ? Bt(this, Zt(e - i, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), f.updateOffset(this, !0), (this._changeInProgress = null))),
        this
      );
    }),
    (pn.utc = function (e) {
        ...
        null != t
          ? ((i = st),
            null != it[e] && null != it[e].parentLocale
              ...
              : (null != (s = ut(e)) && (i = s._config), (t = b(i, t)), null == s && (t.abbr = e), ((n = new x(t)).parentLocale = it[e]), (it[e] = n)),
            lt(e))
